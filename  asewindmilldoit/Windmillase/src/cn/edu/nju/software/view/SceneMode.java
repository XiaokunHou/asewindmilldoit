...
public class SceneMode extends BaseMode implements  TreeModelListener,TreeSelectionListener{
	//JPanel main;
	...
	public SceneMode(){
		...
		//建树
		DefaultMutableTreeNode root=new DefaultMutableTreeNode("所有情境");
	    ...
	    renderer.setLeafIcon(new ImageIcon("src/res/sceneN.png"));
	    renderer.setOpenIcon(new ImageIcon("src/res/sceneN.png"));
	    renderer.setClosedIcon(new ImageIcon("src/res/sceneN.png"));
	...
	//	super.actionPerformed(e);
		if (e.getSource() == over) {
			...
			if(parentPath!=null){
				DefaultMutableTreeNode newNode=new DefaultMutableTreeNode("New Context");
